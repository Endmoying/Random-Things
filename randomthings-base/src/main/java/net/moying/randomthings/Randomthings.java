package net.moying.randomthings;

import com.mojang.logging.LogUtils;
import net.minecraft.client.Minecraft;
import net.minecraft.core.registries.BuiltInRegistries;
import net.minecraft.world.level.block.Blocks;
import net.moying.randomthings.handler.RTEventHandler;
import net.moying.randomthings.init.ModItem;
import net.moying.randomthings.init.ModTab;
...
public class Randomthings {
    ...
    public Randomthings(IEventBus modEventBus, ModContainer modContainer) {
        ...
        ModItem.REGISTRY.register(modEventBus);
